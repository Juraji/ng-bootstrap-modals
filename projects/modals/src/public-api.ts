...
export * from './lib/components/resolve.directive';
export * from './lib/components/dismiss.directive';
export * from './lib/configuration/modal-config';
export * from './lib/util/modal-data';
export * from './lib/util/modal-ref';
